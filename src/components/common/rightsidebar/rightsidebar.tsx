...
function Rightsidebar() {
  ...
  let modelLang : any = document.querySelector("[data-bs-target='#country-selector']")
  return (
    <Fragment>
      <div className="sidebar sidebar-right sidebar-animate">
        <div className="tab-menu-heading p-3">
          <h6 className="mb-0 tx-uppercase tx-semibold">Side Menu</h6>
          <a
            
            className="btn btn-def def-white sidebar-remove ms-auto"
            onClick={() => Remove()}
          >
        ...
        <div className="panel tabs-style2">
          <div className="panel-head">
            ...
            >
                  ...
                  <span>
                    ...
                    >
                      <svg
                        ...
                        className="ionicon right-menu__icon"
                        width={16}
                        height={16}
                        viewBox="0 0 512 512"
                      >
              ...
              >
                <RSC style={{ width: "100%", height: "calc(100vh - 150px)" }}>
                  <div className="tab-pane active" id="side1">
                    <div className="flex-between px-4 mt-3">
                      <a  className="btn btn-sm btn-outline-primary">
                        Mark All As Read
                      </a>
                      <Link
                        to={`${import.meta.env.BASE_URL}pages/notificationlist/`}
                    ...
                    <ul className="list-group list-group-flush mt-3">
                      <li className="list-group-item d-flex">
                        <div className="avatar-badge avatar me-2">
                          <img
                            alt="avatar"
                        ...
                        <div className="flex-1">
                          <h6 className="mb-1">
                            Madeleine
                            <span className="tx-11 tx-muted font-weight-normal float-end">
                              1min ago
                            </span>
                          </h6>
                          <p className="mb-0 tx-12">
                            Added 3 files to
                            <a  className="tx-primary me-1 ms-1">
                              Tempor Dolor
                            </a>
                            task.
                          </p>
                          <div className="bg-black-03  radius-4 p-2 d-flex align-items-center my-1 pos-relative">
                            <div className="wd-40">
                              <img src={Allimages("File1")} alt="docx" />
                            </div>
                            <div className="ms-1 tx-11">
                              <p className="mb-0">WORD_File</p>
                      ...
                      <li className="list-group-item d-flex">
                        <div className="avatar-badge avatar rounded-circle shadow bg-secondary text-dark text-center me-2">
                          <span className="tx-20">LN</span>
                        </div>
                        <div className="flex-1">
                          <h6 className="mb-1">
                            Lee Nonmi
                      ...
                      <li className="list-group-item d-flex">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="mb-0 tx-12">You Have Received 4 files.</p>
                          <div className="bg-black-03  radius-4 p-2 d-flex align-items-center my-1 pos-relative">
                            <div className="wd-40">
                              <img src={Allimages("File6")} alt="ppt" />
                            </div>
                            <div className="ms-1 tx-11">
                              <p className="mb-0">PPT_File</p>
                              <span className="small tx-11">
                                35.9mb
                                <a  className="ms-1">
                                  <i className="fe fe-download tx-11"></i>
                      ...
                      <li className="list-group-item d-flex">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="mb-0 tx-12">Ea duo eos amet ut.</p>
                        </div>
                      </li>
                      <li className="list-group-item d-flex">
                        <div className="avatar-badge avatar me-2">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="mb-0 tx-12">
                            Sed amet stet clita dolores et,.
                          </p>
                        </div>
                      </li>
                    </ul>
                ...
                title={
                  <span>
                    ...
                    >
                      ...
                      <span className="fw-normal"> Chat</span>
                    </a>
                  </span>
                }
              >
              <RSC style={{ width: "100%", height: "calc(100vh - 150px)" }}>
                  <div className="tab-pane" id="side2">
                    ...
                    <div className="px-3 pt-0 pb-3 border-bottom">
                      ...
                      <ul className="list-unstyled mb-0 mt-1">
                        <li>
                          <div className="d-flex">
                            <div className="avatar avatar radius-7 shadow bg-purple-gradient">
                            ...
                            <div className="flex-1 ms-2">
                              <div className="d-flex align-items-center justify-content-between mb-1">
                                <h6 className="mb-0">
                                  Wiley Waites
                                  <span className="badge bg-black-03 text-dark tx-11 ms-2 font-weight-normal">
                                    1
                                  </span>
                                </h6>
                                <span className="tx-11 tx-muted ms-auto my-auto">
                                  2:00 PM
                                </span>
                              </div>
                              <p className="mb-0 tx-12">Aliquyam ipsum sit.</p>
                            </div>
                          </div>
                        </li>
                        <li>
                          <div className="d-flex">
                            <div className="avatar avatar radius-7 shadow bg-teal-gradient">
                            ...
                            <div className="flex-1 ms-2">
                              ...
                              <p className="mb-0 tx-12">At eos no sit...</p>
                            </div>
                          </div>
                        </li>
                        <li>
                          <div className="d-flex">
                            <div className="avatar avatar radius-7 shadow bg-primary-gradient">
                            ...
                            <div className="flex-1 ms-2">
                              ...
                              <p className="mb-0 tx-12">Sit est dolor dolor.</p>
                            </div>
                          </div>
                        </li>
                        <li>
                          <div className="d-flex">
                            <div className="avatar avatar radius-7 shadow bg-secondary-gradient text-dark">
                              <i className="fe fe-terminal"></i>
                            </div>
                            <div className="flex-1 ms-2">
                              <div className="d-flex align-items-center justify-content-between mb-1">
                        ...
                        <li className="mb-0">
                          <div className="d-flex">
                            <div className="avatar avatar radius-7 shadow bg-orange-gradient">
                              <i className="fe fe-airplay"></i>
                            </div>
                            <div className="flex-1 ms-2">
                              <div className="d-flex align-items-center justify-content-between mb-1">
                            ...
                            <div className="flex-1 ms-2">
                              <div className="d-flex align-items-center justify-content-between mb-1">
                                <h6 className="mb-0">
                                  ...
                                  <span className="ms-2">
                                    <i className="ti-pin-alt tx-11 tx-muted"></i>
                                  </span>
                                </h6>
                                <span className="tx-11 tx-muted ms-auto my-auto">
                                  3:55 PM
                              ...
                              <p className="mb-0 tx-12 tx-muted d-flex align-items-center">
                                <i className="fe fe-edit-2 me-1 tx-12 tx-primary"></i>
                                Dulcie is typing...
                              </p>
                            </div>
                          </div>
                        ...
                        <li>
                          <div className="d-flex pos-relative">
                            ...
                            <div className="flex-1 ms-2">
                              ...
                              <p className="mb-0 tx-12 tx-muted d-flex align-items-center">
                                <i className="fe fe-mic me-1 tx-12 tx-primary"></i>
                                Voice message...
                              </p>
                            </div>
                          </div>
                        ...
                        <li>
                          <div className="d-flex pos-relative">
                            ...
                            <div className="flex-1 ms-2">
                              ...
                              <p className="mb-0 tx-12 tx-muted d-flex align-items-center">
                                <i className="fe fe-link-2 me-1 tx-12 tx-primary"></i>
                                <a >http://Diam-duoet.xd</a>
                              </p>
                            </div>
                          </div>
                        </li>
                        <li className="mb-0">
                          <div className="d-flex pos-relative">
                            ...
                            <div className="flex-1 ms-2">
                              ...
                              <p className="mb-0 tx-12 tx-muted d-flex align-items-center">
                                <i className="fe fe-image me-1 tx-12 tx-primary"></i>
                                +10 photos
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="d-flex pos-relative">
                            ...
                            <div className="flex-1 ms-2">
                              <div className="d-flex align-items-center justify-content-between mb-1">
                                <h6 className="mb-0">
                                  Wilfrid Price
                                  <span className="badge bg-danger-transparent tx-danger tx-11 ms-2 font-weight-normal">
                                    3
                                  </span>
                                </h6>
                                <span className="tx-11 tx-muted ms-auto my-auto">
                              ...
                              <div className="d-flex align-items-center justify-content-between">
                                <p className="mb-0 tx-12 tx-muted d-flex align-items-center">
                                  <i className="fe fe-x me-1 tx-13 tx-danger"></i>
                                  Missed call
                                </p>
                                <span className="tx-primary" onClick={()=>{setShow(true)}} style={{ zIndex: '99999999999999999999999' }}>
                                  <i className="fe fe-phone"></i>
                                </span>
                              </div>
                            </div>
                        ...
                        <li>
                          <div className="d-flex pos-relative">
                            ...
                            <div className="flex-1 ms-2">
                              ...
                              <div className="d-flex align-items-center justify-content-between">
                                <p className="mb-0 tx-12 tx-muted d-flex align-items-center">
                                  <i className="fe fe-arrow-down-left me-1 tx-13 tx-primary"></i>
                                  Duration: 15:30
                                </p>
                                <span className="tx-primary" onClick={()=>{setShow(true)}} style={{ zIndex: '99999999999999999999999' }}>
                        ...
                        <li>
                          <div className="d-flex pos-relative">
                            ...
                            <div className="flex-1 ms-2">
                              ...
                              <div className="d-flex align-items-center justify-content-between">
                                <p className="mb-0 tx-12 tx-muted d-flex align-items-center">
                                  <i className="fe fe-arrow-up-right me-1 tx-13 tx-primary"></i>
                                  Declined
                                </p>
                                <span className="tx-primary" onClick={()=>{setShow(true)}} style={{ zIndex: '99999999999999999999999' }}>
                                  <i className="fe fe-video"></i>
                        ...
                        <li className="mb-0">
                          <div className="d-flex pos-relative">
                            ...
                            <div className="flex-1 ms-2">
                              ...
                              <div className="d-flex align-items-center justify-content-between">
                                <p className="mb-0 tx-12 tx-muted d-flex align-items-center">
                                  <i className="fe fe-arrow-down-left me-1 tx-13 tx-success"></i>
                                  Duration: 01:20:10
                                </p>
                                <span className="tx-primary" onClick={()=>{setShow(true)}} style={{ zIndex: '99999999999999999999999' }}>
                                  <i className="fe fe-phone"></i>
                    ...
                    <div className="p-3 text-center">
                      <div className="svg-card overflow-hidden">
                        <svg className="svg-find" width="150" height="150">
                          <defs></defs>
                            ...
                            >
                              ...
                              >
                                ...
                                <path
                                  ...
                                  className="color1f60e5 svgShape"
                                ></path>
                                <g
                                  clipPath="url(#a)"
                                  opacity=".81"
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    <path
                                      ...
                                      className="color2d1d2c svgShape"
                                    ></path>
                                    <path
                                      fill="#ffffff"
                                    ...
                                    <path
                                      ...
                                      opacity=".5"
                                      className="color003fc3 svgShape"
                                    ></path>
                                    <path
                                      fill="#ffffff"
                                  ...
                                  <line
                                    ...
                                    strokeMiterlimit="10"
                                    strokeWidth="2"
                                    className="colorStroke1f60e5 svgStroke"
                                  ></line>
                                  <line
                                    x1="1790.62"
                                    x2="2066.7"
                                ...
                                <path
                                  fill="#ff9541"
                                  d="M2256.78,639.72C2151.45,583.53,2021,624.56,1966.58,730c-53.65,103.91-12.82,233,90.83,287.13a212.14,212.14,0,0,0,97.32,24.27l43.72,345.21a16.51,16.51,0,0,0,19.53,14.1l.33-.07a16.44,16.44,0,0,0,13.13-18.21L2188.21,1039a213.12,213.12,0,0,0,159-115.68C2398.55,820.46,2358.23,693.87,2256.78,639.72ZM2327,915.1c-48.11,94.33-163.57,131.79-257.9,83.68s-131.8-163.59-83.69-257.92S2149,609.07,2243.33,657.2,2375.13,820.77,2327,915.1Z"
                                  className="colorfe7101 svgShape"
                                ></path>
                                <path
                                  fill="url(#i)"
                                ...
                                <path
                                  ...
                                  className="colorf8bbc2 svgShape"
                                ></path>
                                <path
                                  fill="#ffcdcd"
                                ...
                                <path
                                  ...
                                  d="M3492.39,1087.57l-307.23,113.54v-72.69a34.35,34.35,0,0,1,16.85-29.54c42.48-25.14,154.66-86,219.67-121,3.9-2.14,7.64-4.14,11.18-6.06q2.57-1.37,5-2.67A26.17,26.17,0,0,1,3476.05,988Z"
                                  opacity=".55"
                                  className="color04137a svgShape"
                                ></path>
                                <path
                                  fill="#319bc1"
                                ...
                                <path
                                  ...
                                  className="color512d50 svgShape"
                                ></path>
                                <path
                                  fill="#161c1d"
                                ...
                                <path
                                  ...
                                  opacity=".3"
                                  className="colore8635d svgShape"
                                ></path>
                                <path
                                  fill="#e68888"
                                ...
                                <path
                                  ...
                                  opacity=".18"
                                  className="colorfe8796 svgShape"
                                ></path>
                                <path
                                  fill="#f17684"
                                ...
                                <path
                                  ...
                                  opacity=".71"
                                  className="color020e49 svgShape"
                                ></path>
                                <path
                                  fill="#020e49"
                                ...
                                <path
                                  ...
                                  opacity=".18"
                                  className="color03157a svgShape"
                                ></path>
                                <path
                                  fill="#006096"
                                ...
                                <circle
                                  ...
                                  className="colorffb600 svgShape"
                                ></circle>
                                <circle
                                  cx="3819.09"
                                  cy="2673.01"
                  ...
                  <div className="tab-pane" id="side3">
                        ...
                        <div className="panel-head">
                          ...
                          >
                            <Tab eventKey="home" title="Home">
                              <div className="tab-pane active" id="tab_chat">
                                <div className="mt-3">
                                  <label className="d-flex align-items-center justify-content-between">
                                    <span className="tx-muted d-flex align-items-center">
                                      Someone mentioned
                                    </span>
                                    <input
                                      type="checkbox"
                                    ...
                                    />
                                    <span className="custom-switch-indicator float-end"></span>
                                  </label>
                                </div>
                                <div className="mt-3">
                                  <label className="d-flex align-items-center justify-content-between">
                            ...
                            <Tab eventKey="tasks" title="Tasks">
                              <div className="tab-pane" id="tab_tasks">
                                <div className="mt-3">
                                  <label className="d-flex align-items-center justify-content-between">
                                    <span className="tx-muted d-flex align-items-center">
                                      Assigned a Task
                            ...
                            <Tab eventKey="app" title="App">
                              <div className="tab-pane" id="tab_app">
                                <div className="mt-3">
                                  <label className="d-flex align-items-center justify-content-between">
                                    <span className="tx-muted d-flex align-items-center">
                                      Weekly Report
                    ...
                    <div className="p-3 border-bottom">
                      ...
                      <div className="panel mt-2 tabs-style5">
                        <div className="panel-head">
                          <Tabs
                            defaultActiveKey="tabapps"
                            id="uncontrolled-tab-example"
                            className="mb-3"
                          >
                            <Tab eventKey="tabapps" title="Account">
                              <div className="tab-pane active" id="tab_apps">
                                <div className="mt-3">
                                  <p className="mb-0">Connected Apps</p>
                                  <div className="mt-3">
                                    <label className="mb-0 flex-between">
                                ...
                                <div className="mt-4">
                                  <p className="mb-0">Login & Security</p>
                                  <div className="mt-3">
                                    <div className="form-group mb-0">
                                      <p className="mb-2 flex-between">
                                        <label
                                          htmlFor="inputPassword"
                                          className="mb-0 tx-muted"
                                        >
                                          Password
                                        </label>
                                        <a onClick={()=>{
                                      ...
                                      <input
                                        className="form-control form-contron-sm radius-4"
                                        id="inputPassword"
                                        type="password"
                                        placeholder="Enter New Password"
                                        defaultValue="passwordzem"
                                      />
                                      {
                                        reEnterPassword && 
                                      <div
                            ...
                            <Tab eventKey="tabprofile" title="Profile">
                              <div className="tab-pane" id="tab_profile">
                                <div className="mt-3">
                                  ...
                                  <div className="form-group">
                                    ...
                                    <input
                                      ...
                                      defaultValue="nicktaylor@spruko.me"
                                    />
                                  </div>
                                  <div className="form-group">
                                    <label
                                      htmlFor="inputNumber"
                                      className="tx-muted flex-between"
                                    >
                                      Mobile Number
                                      <a
                                        onClick={()=>{modelLang.click()}}
                                        className="tx-11 tx-primary"
                                    ...
                                    <div className="input-group">
                                      <span className="input-group-text br-ts-20 br-bs-20">
                                        +11
                                      </span>
                                      <input
                                        type="number"
                                        className="form-control br-te-4 br-be-4"
                                        id="inputNumber"
                                        placeholder="Enter Your Number"
                                        defaultValue="1179360254"
                                      />
                                    </div>
                                  </div>
                                </div>
...
Profile
                    ...
                    <div className="p-3 border-bottom">
                      ...
                      <div className="mt-3">
                        <label className="d-flex align-items-center justify-content-between">
                          <span className="tx-muted">Back to top</span>
                          <input
                            type="checkbox"
                            className="custom-switch-input backToTopCheckbox"
                            defaultChecked
                          />
                          <span className="custom-switch-indicator"></span>
                        </label>
                    ...
                    <div className="p-3">
                      <div className="text-center">
                              ...
                              >
                                ...
                                >
                                  <rect
                                    ...
                                    className="colorStroke008ef8 svgStroke"
                                  ></rect>
                                  <circle
                                    cx="405.4"
                                    cy="429.06"
                                    r="29.82"
                                    fill="var(--primary03)"
                                    className="colorc1e3f7 svgShape"
                                  ></circle>
                                  <path
                                    fill="var(--primary04)"
                                    ...
                                    className="colorfff8e9 svgShape"
                                  ></path>
                                  <path
                                    fill="var(--primary-bg-color)"
                                    ...
                                    className="color008ef8 svgShape"
                                  ></path>
                                  <path
                                    fill="#489ee0"
                                    ...
                                    className="color489ee0 svgShape"
                                  ></path>
                                  <path
                                    fill="#1e3a73"
                                    ...
                                    className="color2428bb svgShape"
                                  ></path>
                                  <rect
                                    width="73.48"
                                    height="49.92"
                                  ...
                                  <rect
                                    ...
                                    y="101.73"
                                    fill="#6784e4"
                                    className="color0234c1 svgShape"
                                  ></rect>
                                  <path
                                    fill="#a0c2ea"
                                    ...
                                    className="colora0c2ea svgShape"
                                  ></path>
                                  <path
                                    fill="#ff9c76"
                                    ...
                                    className="colorf46534 svgShape"
                                  ></path>
                                  <path
                                    fill="#ff9c76"
                                  ...
                                  <path
                                    ...
                                    className="colorffedc5 svgShape"
                                  ></path>
                                  <path
                                    fill="#bdbcbc"
                                    ...
                                    className="colora3a3a3 svgShape"
                                  ></path>
                                  <path
                                    fill="#e2e2e2"
                                    ...
                                    className="color7f7f7f svgShape"
                                  ></path>
                                  <ellipse
                                    cx="64.99"
                                    cy="471.99"
                                    ...
                                    rx="19.68"
                                    ry="34.1"
                                    className="colorStrokeffcd52 svgStroke"
                                  ></ellipse>
                                  <path
                                    fill="#ffcd52"
                                    ...
                                    className="colorffcd52 svgShape"
                                  ></path>
                                  <ellipse
                                    cx="95.27"
                                    cy="459.81"
                                  ...
                                  <ellipse
                                    ...
                                    rx="19.68"
                                    ry="34.1"
                                    className="colorStrokeff5061 svgStroke"
                                  ></ellipse>
                                  <polyline
                                    fill="none"
                                    stroke="#ff5061"
                                  ...
                                  <line
                                    ...
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                                    className="colorStroke545454 svgStroke"
                                  ></line>
                                </g>
                              </g>
                            </svg>
                        ...
                        <h6 className="mt-4">
                          This Is Not You're Looking For?
                        </h6>
                        <Link
                          to={`${import.meta.env.BASE_URL}pages/settings/`}
                          className="btn btn-block btn-outline-primary"
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <h5>Zem Voice call</h5>
         <img src={Allimages("User6")} 
         className="rounded-circle user-img-circle h-8 w-8 mt-4 mb-3" alt="img"/> 
         <h4 className="mb-1  font-weight-semibold">Daneil Scott</h4>
          <h6>Calling...</h6> 
          <div className="flex-center mt-4 p-2"> 
          <a className="btn btn-outline-primary rounded-circle ht-40 wd-40 flex-center"
           href="javascript:void(0);"> 
           <i className="fas fa-volume-up"></i> 
           </a> 
           <a className="btn btn-danger rounded-circle ht-50 wd-50 flex-center mx-3"
            href="javascript:void(0);" data-bs-dismiss="modal" aria-label="Close">
               <i className="fas fa-phone"></i> </a>
                <a className="btn btn-outline-primary rounded-circle ht-40 wd-40 flex-center" 
                href="javascript:void(0);"> <i className="fas fa-microphone-slash"></i> </a> 
          </div> 
        </Modal.Body>
      </Modal>
    </Fragment>
