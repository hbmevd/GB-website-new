...
function Sidebar({
      ...
      menuitems.map((mainlevel: any) => {
        if (mainlevel.Items) {
          mainlevel.Items.map((items: any) => {
            ...
            if (
              location.pathname === "/test/zem-ts/preview/" ||
              location.pathname === "/test/zem-ts/preview"
            ) {
  ...
  function toggleSidemenu(item: any) {
    ...
    if (localStorage.dataverticalstyleicontext == "icontext") {
      ...
      ThemeChanger({
        ...
        body: {
          class:
            "ltr main-body app index sidebar-mini sidenav-toggled sidenav-toggled-open",
        },
      });
      document.querySelector(".main-content")?.addEventListener("click", () => {
        if (localStorage.dataverticalstyleicontext == "icontext") {
          ThemeChanger({
            ...theme,
            body: {
              class: "ltr main-body app index sidebar-mini sidenav-toggled",
            },
          });
        }
      });
  ...
  function Onhover() {
    if (
      ...
      localStorage.dataverticalstyleicontext != "icontext"
    ) {
