...
import { Alertdatacontentdata, Alertdatalinkdata, initialListdata, initialListdismissingdata, initialListiconsdata } from '../../../common/elementsdata/elementsdata';
                ...
                <div className="example">
                  <Fragment>
                    {alertData.map((item, k) => (
                      <Fragment key={k}>
                        <Alert className="alert alert-dismissible fade show " variant={item.variant}>
            ...
            <Card.Body>
              <div>
                <div className="d-flex flex-wrap">
                  <h6 className="card-title mb-1">Dismiss Alerts</h6>
                  <Form.Check
                    label="Show Code"
                    type="switch"
                    ...
                    {initialListiconsdata.map((playerData, k) => (
                      <Fragment key={k}>
                        ...
                        >
                          ...
                          <span className="alert-inner--icon me-2 align-middle me-2 align-middle">
                    ...
                    {iconsdismissing.map((playerData) => (
                      <Fragment key={playerData.id}>
                        ...
                        >
                          ...
                          <span className="alert-inner--icon me-2 align-middle ">
                            <i className={`${playerData.icons} `}></i>
                          </span>
                          <span className="alert-inner--text">
                            <strong>{playerData.show}</strong> {playerData.text}
                  ...
                  <Fragment>
                    ...
                    {Alertdatalinkdata.map((playerData, k) => (
                      <Alert key={k} variant="" className={`alert alert-${playerData.color}`}>
                        ...
                        <Alert.Link className="alert-link mx-1" >
                          an example link
                        </Alert.Link>
...
<Alert key={k} variant="" className={alert alert-{playerData.color}}>
This is a {playerData.color} alert with
<Alert.Link className="alert-link" >
an example link
</Alert.Link>
. Give it a click if you like.
</Alert>
                      ...
                      >
                        <Alert.Heading>
                          <h4 className="alert-heading">
                            <i className={`${playerData.fe} me-2 d-inline-block tx-20`}></i>
                            {playerData.text}
                          </h4>
                        </Alert.Heading>
                        <p>
