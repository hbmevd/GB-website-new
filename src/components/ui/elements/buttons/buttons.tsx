...
import {
  Buttonwithiconsdata,
  Buttonwithloadinganimationdata,
  Defaultbuttonsdata,
  Disabledbuttonsdata,
  Gradientbuttonsdata,
  Iconbuttonsdata,
...
function Buttons() {
  ...
  return (
    <Fragment>
      <Pageheader titles={"BUTTONS"} active={"Buttons"} Subtite={"Elements"} />
...
`}
        ...
        <Col md={12} lg={12}>
          <Card>
            <Card.Header>
              <div className="d-sm-flex justify-content-between">
                <div className="card-title">DISABLED BUTTONS</div>
                <Form className="ms-auto ps-3">
                  <Form.Check
                    label="Show Code"
                    type="switch"
                    id="custom-switch"
                ...
                <div className="example">
                  <div className="btn-list">
                    {Gradientbuttonsdata.map((idx) => (
                      <Button
                        variant=""
                        className={`btn me-2 btn-${idx.color}-gradient `}
                        key={Math.random()}
                      >
                        {idx.text}
                      </Button>
...
`}
        ...
        <Col md={12} lg={12}>
          ...
          <Card.Header>
              <div className="d-sm-flex justify-content-between">
            <div className="card-title">LIGHT BUTTONS</div><Form className="ms-auto">
                  <Form.Check
                    label="Show Code"
                    type="switch"
                    id="custom-switch"
                ...
                <div className="example">
                  <div className="btn-list">
                    {Lightbuttonsdata.map((idx) => (
                      <Button
                        variant=""
                        className={`btn btn-${idx.color}-light ${idx.class}`}
                        key={Math.random()}
                      >
                        {idx.text}
                      </Button>
...
`}
        ...
        <Col lg={6} md={12} xl={6}>
          ...
          <Card.Header>
              <div className="d-sm-flex justify-content-between">
            <div className="card-title">BUTTONS WITH LOADING ANIMATIONS</div>
                <Form className="d-flex ms-auto">
                  <Form.Check
                    label="Show Code"
                    type="switch"
                  ...
                  <Row className="row-xs wd-xl-80p btn-list btn-animation">
                    {Buttonwithloadinganimationdata.map((idx) => (
                      <Button
                        variant=""
                        type="button"
                        className={`btn btn-${idx.color} btn-${idx.class} ms-2`}
                        key={Math.random()}
                      >
...
`}
        ...
        <Col lg={6} md={12} xl={6}>
          <Card>
            <Card.Header>
              <div className="d-sm-flex justify-content-between">
              <div className="card-title">BUTTON WITH ICONS</div>
                <Form className="d-flex ms-auto">
                  <Form.Check
                    label="Show Code"
                    type="switch"
                  ...
                  <Row className="row-xs wd-xl-80p btn-list">
                    {Buttonwithiconsdata.map((idx) => (
                      <Button
                        variant=""
                        type="button"
                        className={`btn btn-${idx.color} button-icon btn-icons`}
                        key={Math.random()}
                      >
                  ...
                  <div className="btn-icon-list btn-list flex-wrap">
                    {Iconbuttonsdata.map((idx) => (
                      <Button
                        variant=""
                        type="button"
                        className={`btn btn-icon btn-${idx.color} me-1`}
                        key={Math.random()}
                      >
                        <i className={`fe fe-${idx.icon}`}></i>
                      </Button>
                    ))}
                  </div>
                </div>
...
`}
        ...
        <Col lg={6} md={12} xl={6}>
          <Card>
            <Card.Header>
              <div className="d-sm-flex justify-content-between">
              <div className="card-title">BUTTON SIZE</div>
                <Form className="d-flex ms-auto">
                  <Form.Check
                    label="Show Code"
                    type="switch"
...
`}
        ...
        <Col md={12} xl={6}>
          <Card>            
            <Card.Header>
              <div className="d-sm-flex justify-content-between">
              <div className="card-title">CHECKBOX BUTTONS GROUP </div>
                <Form className="d-flex ms-auto">
                  <Form.Check
                    label="Show Code"
                    type="switch"
...
`}
        ...
        <Col md={12} xl={6}>
          <Card>
            <Card.Header>
              <div className="d-sm-flex justify-content-between">
              <div className="card-title">RADIO BUTTONS GROUP </div>
                <Form className="d-flex ms-auto">
                  <Form.Check
                    label="Show Code"
                    type="switch"
...
`}
        ...
        <Col lg={12} md={12} xl={12}>
          <Card>
            <Card.Header>
              <div className="d-sm-flex justify-content-between">
              <div className="card-title">TOGGLE BUTTONS </div>
                <Form className="d-flex ms-auto">
                  <Form.Check
                    label="Show Code"
                    type="switch"
...
`}
        ...
        <Col lg={12} md={12} xl={12}>
          <Card id="button61">
            <Card.Header>
              <div className="d-sm-flex justify-content-between">
              <div className="card-title">DROPDOWN BUTTONS </div>
                <Form className="d-flex ms-auto">
                  <Form.Check
                    label="Show Code"
                    type="switch"
            ...
            <Card.Body>
              <div className="text-wrap">
                <div className="example button-variant">
...
`}
        ...
        <Col lg={12} md={12} xl={12}>
          <Card id="button7">
            <Card.Header>
              <div className="d-sm-flex justify-content-between">
              <div className="card-title">BUTTONS GROUPS </div>
              <Form className="d-flex ms-auto">
                <Form.Check
                  label="Show Code"
                  type="switch"
