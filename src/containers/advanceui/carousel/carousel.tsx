          ...
          <Card>
            ...
            <Card.Body>
              <p className="card-subtitle">
                ...
                Multislider allows the developer to focus fully on each
                individual slide as it's own component, and then displays as
                many slides as you decide in a manner that is fluid, consistent,
                and dymanic.
              </p>
              <Multislider />
            </Card.Body>
