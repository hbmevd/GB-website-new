...
const Treeview = () => {
  ...
  const handleExpandClick = () => {
    setExpanded((oldExpanded: string | any[]) =>
  ...
  return (
    ...
    <Fragment>
      <Pageheader titles="TREEVIEW" Subtite="Apps" active="Treeview" />
      <Row>
        <Col md={12}>
              ...
              <Row>
                ...
                <Col className="mt-4 mt-lg-0" lg={6} xl={4} md={12} sm={12}>
                  <span id="tree3" className="tree">
                    <div>
                      <Button variant="primary" className='btn mb-2' onClick={handleExpandClick} >
