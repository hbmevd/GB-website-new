...
function Typoicons() {
  return (
    <>
      <Pageheader titles={'Typicons'} active={'Typicons'} Subtite={'Icons'} />
            ...
            <Card.Body>
              <Row className="row-sm">
                <Col lg={12} sm={12} className="mb-2">
                  <h5 className="mb-2">Typicons icons</h5>
                  <p className="mb-2 tx-muted">Simply beautiful open source icons. For more info <a href="https://www.s-ings.com/typicons/" target="_blank" className="tx-primary">click here</a>.</p>
