...
const AfterCompleted = () => <span>You are good to go!</span>;

const rendered = ({ days, hours, minutes, seconds, completed }: any) => {
  if (completed) {
...
export function DayCounter1() {
  return <Countdown date={Date.now() + 6288800000} renderer={rendered} />;
}

//
const render = ({ days, hours, minutes, seconds }: any) => (
  <Row className=" row-sm mx-auto">
    <div id="count-down" className="center-block mt-3 mb-3 mx-auto justify-content-center d-flex flex-wrap">
      <div className="clock-presenter days_dash">
...
export const Underconstructions = () => (
  <Countdown date={Date.now() + 6288800000} renderer={render} />
);
